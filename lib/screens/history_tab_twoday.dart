...
class HistoryTwoDay extends StatefulWidget {
  const HistoryTwoDay({Key? key}) : super(key: key);

  @override
  _HistoryTwoDayState createState() => _HistoryTwoDayState();
}

class _HistoryTwoDayState extends State<HistoryTwoDay> {
