...
class DestMarkerDetails extends StatefulWidget {
  const DestMarkerDetails({Key? key}) : super(key: key);

  @override
  State<DestMarkerDetails> createState() => _DestMarkerDetailsState();
}

class _DestMarkerDetailsState extends State<DestMarkerDetails> {
